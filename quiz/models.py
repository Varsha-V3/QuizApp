...
class MyUser(models.Model):
	...
	email_1 = models.EmailField(unique=True, verbose_name='Email')
	phone_number_1 = models.CharField(validators=[phone_regex], max_length=17, blank=False, verbose_name='Mobile Number')
...
class Question(models.Model):
	CATEGORY_CHOICES = [('Python','Python'),('Linux','Linux')]
	...
	category = models.CharField(max_length=6, default='Python', verbose_name='Category', choices=CATEGORY_CHOICES)
